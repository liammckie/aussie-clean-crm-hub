...
export const contractDetailsFields = {
  ...
  'Financial Details': [
    ...
    { key: 'supplier_cost_weekly', label: 'Weekly Supplier Cost', type: 'currency' },
    { key: 'supplier_cost_monthly', label: 'Monthly Supplier Cost', type: 'currency' },
    { key: 'supplier_cost_annual', label: 'Annual Supplier Cost', type: 'currency' },
    { key: 'profit_margin_percentage', label: 'Profit Margin %', type: 'percentage' },
